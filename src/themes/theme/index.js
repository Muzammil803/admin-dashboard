...
const Theme = () => {
  ...
  let primaryColors = ['#D6E4FF', '#D6E4FF', '#ADC8FF', '#84A9FF', '#6690FF', '#3366FF', '#2790C3', '#1939B7', '#102693', '#102693'];
  let secondaryColors = ['#F8F9FA', '#F8F9FA', '#2790C3', '#DBE0E5', '#fcb52736', '#8996A4', '#5B6B79', '#3E4853', '#1D2630', '#131920'];
  ...
  let sicpaColors = ['#fcb527','#37D5D5','#2790C3']
